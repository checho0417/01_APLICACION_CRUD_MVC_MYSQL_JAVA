...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/estilos/dashboardnequi.css">
    <title>Dashboad Nequi</title>
</head>
<body>
    ...
    <div id="esco">
        ...
        <div id="sub">
            ...
            <div id="cuenta">
                ...
                <br>
                cuenta Numero Celular 319549****
                </h2>
            </div>

            <div>
                <img id="logito" src="assets/imagenes/nequi-logo.png" alt="">
            </div> 
